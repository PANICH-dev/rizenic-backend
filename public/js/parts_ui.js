    ...
    try {
        ...
        if(res.ok) {
            ...
            if(m) {
                ...
                document.getElementById('master_category').value = m.part_category || m.part_type || 'หลัก'; document.getElementById('master_price').value = parseFloat(m.unit_price || 0).toFixed(2);
